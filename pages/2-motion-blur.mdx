...
<Tabs>
  <Tab label="Rust">
    ```rust {4,8,12,24-26} filename="ray.rs | Adding time to Ray"
    pub struct Ray {
        orig: Point3,
        dir: Vec3,
        pub tm: f64,
...
<Tabs>
  <Tab label="Rust">
    ```rust {4,9} filename="camera.rs | Camera generating rays with random time"
...
<Tabs>
  <Tab label="Rust">
    ```rust {2,11,17-24} filename="sphere.rs | Sphere with optional motion"
    pub struct Sphere {
...
<Tabs>
  <Tab label="Rust">
    ```rust {3-4,15} filename="sphere.rs | Moving sphere hit function"
...
<Tabs>
  <Tab label="Rust">
    ```rust {2,12,23,43} filename="material.rs | Handle ray time in scatter methods"
...
<Tabs>
  <Tab label="Rust">
    ```rust {5,8-12,26,28} filename="main.rs | Last book's final scene, but with moving spheres"
